  ...
  const sections = [
    {
      ...
      description:
        "View store location, type, and associated contact information",
      link: "operational-manager/store-operational-manager/store-details-page",
    },
    {
      title: "Products Details",
      description: "Add, edit, and track Product performance",
      link: "operational-manager/store-operational-manager/store-products-details-page",
    },
    {
      title: "Employee Details",
      description: "Manage permissions, performance and roles",
      link: "operational-manager/store-operational-manager/store-employee-details-page",
    },
    {
      title: "Analytics and Reports",
      description:
        "View insights for store, product, performance and promotions",
      link: "operational-manager/store-operational-manager/store-analytics-reports-page",
    },
    {
      title: "Supplier Details",
      description: "View, approve or request supplier promotions",
      link: "operational-manager/store-operational-manager/store-supplier-details-page",
    },
    {
      title: "Promotion Details",
      description: "View all promotions",
      link: "operational-manager/store-operational-manager/store-promotion-details-page",
    },
  ];
