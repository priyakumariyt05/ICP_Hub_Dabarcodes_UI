      ...
      <ul className="mt-10">
        ...
        {openSection === "home" && (
          <ul className="ml-8">
            ...
            >
              <Link to="/operational-manager/getting-started">
                <AiOutlineMinus className="inline-block mr-2" /> Getting Started
              </Link>
            </li>
            <li
              className={`px-6 py-2 hover:bg-gray-200 cursor-pointer ${
                location.pathname === "/operational-manager/home-dashboard"
                  ? "bg-sky-300"
                  : ""
              }`}
            >
              <Link to="/operational-manager/home-dashboard">
        ...
        >
          <div className="flex justify-between items-center">
            <Link to="/operational-manager/store" className="flex items-center">
        ...
        {openSection === "product" && (
          <ul className="ml-8">
            <li
              className={`px-6 py-2 hover:bg-gray-200 cursor-pointer ${
                location.pathname === "/operational-manager/all-product"
                  ? "bg-sky-300"
                  : ""
              }`}
            >
              <Link to="/operational-manager/all-product">
                <AiOutlineMinus className="inline-block mr-2" /> All Product
              </Link>
            </li>
            <li
              className={`px-6 py-2 hover:bg-gray-200 cursor-pointer ${
                location.pathname === "/operational-manager/product-promotion"
                  ? "bg-sky-300"
                  : ""
              }`}
            >
              <Link to="/operational-manager/product-promotion">
        ...
        >
          <div className="flex justify-between items-center">
            <Link
              to="/operational-manager/plan-pricing"
        ...
        {openSection === "reports" && (
          <ul className="ml-8">
            <li
              className={`px-6 py-2 hover:bg-gray-200 cursor-pointer ${
                location.pathname === "/operational-manager/product-performance"
                  ? "bg-sky-300"
                  : ""
              }`}
            >
              <Link to="/operational-manager/product-performance">
            ...
            <li
              className={`px-6 py-2 hover:bg-gray-200 cursor-pointer ${
                location.pathname === "/operational-manager/story-broads"
                  ? "bg-sky-300"
                  : ""
              }`}
            >
              <Link to="/operational-manager/story-broads">
        ...
        >
          <div className="flex justify-between items-center">
            <Link to="/operational-manager/Role" className="flex items-center">
        ...
        {openSection === "supplier" && (
          <ul className="ml-8">
            <li
              className={`px-6 py-2 hover:bg-gray-200 cursor-pointer ${
                location.pathname === "/operational-manager/supplier-list"
                  ? "bg-sky-300"
                  : ""
              }`}
            >
              <Link to="/operational-manager/supplier-list">
                <AiOutlineMinus className="inline-block mr-2" /> Supplier List
              </Link>
            </li>
            <li
              className={`px-6 py-2 hover:bg-gray-200 cursor-pointer ${
                location.pathname === "/operational-manager/promotion-request"
                  ? "bg-sky-300"
                  : ""
              }`}
            >
              <Link to="/operational-manager/promotion-request">
