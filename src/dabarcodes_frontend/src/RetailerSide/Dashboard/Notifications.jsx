...
//     description:
//       "Supplier XYZ Supplier has submitted a new promotion request for Product Nestle Coffee 500g pouch.",
...
//   return (
//     <div className="p-4 bg-white border border-[#E5E5E5] rounded-md shadow-sm mb-6">
//       {/* Card content */}
//       <p className="font-semibold text-md">{title}</p>
//       <p className="text-sm text-[#646464] mt-2">{description}</p>
//       {dateRange && <p className="text-sm text-[#646464] mt-2">{dateRange}</p>}
//       <button className="mt-4 border border-[#0D90C1] text-[#0D90C1] px-4 py-2 rounded hover:bg-[#E7F8FE] font-medium">
//         {buttonText}
//       </button>
//     </div>
//   );
