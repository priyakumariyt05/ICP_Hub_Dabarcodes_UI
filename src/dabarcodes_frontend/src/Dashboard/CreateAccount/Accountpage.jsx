...
const AccountPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white p-4 md:p-8 font-roboto">
      ...
      {/* Sidebar */}
      <Asidebar sidebarOpen={sidebarOpen} title="Become Our Retailer" />
      ...
      >
        ...
        <div>
          ...
          <form>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col">
                <label htmlFor="input1" className="text-gray-800 py-2 font-semibold">
                  Pronouns <span className="text-black">*</span>
                </label>
                <select className="p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
                  <option>Select</option>
                  <option>He</option>
            ...
            {/* Store Address */}
            <h2 className="text-xl font-semibold my-6">Retailer Head Office Address</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <div className="flex flex-col">
