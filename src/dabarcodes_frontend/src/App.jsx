...
const PaymentProcessCard = lazy(() => import("./SmallPages/PaymentProcessCard"));
...
const AdditionalInformation = lazy(() => import("./ProfileDetails/AdditionalInformation"));
const Filter = lazy(() => import("./Dashboard/Filter"));
const Home = lazy(() => import("./Layout/Home"));
const DashboardRoutes = lazy(() => import("./Dashboard/DashboardRoutes"));
const PrivacyPreference = lazy(() => import("./ProfileDetails/PrivacyPreference"));
const HomePage2 = lazy(() => import("./NewHomePageCustomer.jsx/Homepage2"));
const TopSku = lazy(() => import("./NewHomePageCustomer.jsx/TopSku"));
const HomeProductCard = lazy(() => import("./NewHomePageCustomer.jsx/HomeProductCard"));
const SessionExpiredModal = lazy(() => import("./NewHomePageCustomer.jsx/SessionExpiredModal"));
const SessionTimeoutModal = lazy(() => import("./NewHomePageCustomer.jsx/SessionTimeOutModal"));
const SkuOverlay = lazy(() => import("./NewHomePageCustomer.jsx/SkuOverlay"));
const PaymentDetailsCard = lazy(() => import("./NewHomePageCustomer.jsx/PaymentDetailsCard"));
