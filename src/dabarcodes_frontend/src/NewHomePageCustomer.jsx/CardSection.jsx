      ...
      <div className="border border-red-500 rounded-lg p-4 flex flex-col justify-between bg-white shadow-sm w-full">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex flex-col justify-between h-full flex-start">
            ...
            <p className="text-sm text-gray-500 font-meduium font-roboto my-2">Promoted by: 
            <br/>
  ...
  {product.brand}
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="text-sm text-gray-600 font-roboto">
            ...
            <h3 className="text-[1rem] font-extrabold leading-[1.2rem] text-black mt-3">{product.name}</h3>
