...
const RetailerCarousel = ({ title, retailers, buttonLabel, onViewAllClick }) => {
  ...
  return (
    <div className="p-10 ">
      <div className="flex justify-between items-center mb-8">
        ...
        <button className="text-black px-4 py-2 rounded-full font-roboto" onClick={onViewAllClick}>
          {buttonLabel}
        </button>
      </div>
      <Slider {...settings}>
