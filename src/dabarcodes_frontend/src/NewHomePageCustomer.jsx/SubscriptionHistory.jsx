...
const SubscriptionHistory = ({ history }) => {
  return (
    <div className="p-4 border border-gray-200 rounded shadow-md">
      <div className="flex justify-between items-center mb-4">
        <span className="text-black font-roboto text-xl my-2 font-bold">
          Subscription History
        </span>
        <a href="#" className="text-black font-roboto">
          View All
        </a>
      </div>
      ...
      <div className="overflow-x-auto">
        <ul className="min-w-full">
          {history.map((item, index) => (
            <li
              key={index}
              className="flex justify-between items-center mb-2 min-w-max"
            >
              <div>
                <div
                  style={{
