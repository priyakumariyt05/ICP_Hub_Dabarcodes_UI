...
// import { MdOutlineEdit, MdImage } from 'react-icons/md';
...
//           <MdImage className="h-6 w-6 text-gray-600 mr-2" /> {/* Image Icon Placeholder */}
//           <span className="text-gray-600">Need more Utility Tokens?</span>
//         </div>
//         <a href="#" className="text-blue-500">Purchase Now</a>
//       </div>
...
//           ) : (
//             <>
//               <button className="mt-2 py-2 px-4 bg-blue-100 text-blue-500 rounded-md">
...
//   return (
//     <div className="max-w-xl ml-0 p-4 bg-white"> {/* Container aligned to the left */}
//       {/* Utility Token Purchase */}
//       <div className="flex items-center justify-between mb-4 p-4 border border-gray-200 rounded">
//         <div className="flex items-center">
//           {/* <MdImage className="h-6 w-6 text-gray-600 mr-2" />  */}
//           <img src="/image/token.png" alt="" />
//           <span className="text-gray-600">Need more Utility Tokens?</span>
