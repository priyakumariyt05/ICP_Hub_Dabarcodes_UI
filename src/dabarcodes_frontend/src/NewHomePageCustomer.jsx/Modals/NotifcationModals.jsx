...
//   const { isNotificationsOn, closeNotifications } = useModal(); // Use modal state from context
...
//   if (!isNotificationsOn) return null; // Return null if modal is not open
...
// const CardComponent = ({ imgSrc, title, skuName, promotionDetail, validTill, buttonText }) => {
//   return (
