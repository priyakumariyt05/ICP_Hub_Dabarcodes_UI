  ...
  return (
    <div className="bg-white p-8 mx-4 lg:mx-16">
      ...
      <p className="text-gray-600 mb-8">
        Select a plan that best fits your needs. Each plan gives you a different
        number of utility tokens to link with your favorite SKUs.
      </p>
      <div className="flex flex-col lg:flex-row justify-between items-start space-y-4 lg:space-y-0 lg:space-x-4">
        <SubscriptionCard
          title="Regular"
          tokens="10 utility token monthly"
          price="$10.99/month"
        />
        <SubscriptionCard
          title="Silver"
          tokens="45 utility token monthly"
          price="$29.99/month"
        />
        <SubscriptionCard
          title="Gold"
          tokens="95 utility token monthly"
          price="$49.99/month"
        />
