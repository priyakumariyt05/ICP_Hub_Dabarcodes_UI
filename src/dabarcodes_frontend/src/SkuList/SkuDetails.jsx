...
import SkuProductDetails from './SkuProductDetails';
            ...
            <p className="text-gray-600 mb-2 font-roboto leading-[19.2px]">See other flavors</p>
             <hr className="border-t-2 border-gray-200 mb-4" />
              ...
              <div className="flex flex-wrap space-x-2 mb-2 md:mb-0">
                <button className="px-4 py-2 bg-gray-200 rounded mb-1">Peanut Butter</button>
...
Brand
 ...
 {/* <li className="font-roboto text-[16px] leading-[19.2px] text-left text-[#171717] my-2">
  ...
  <span className=" text-blue-500 underline cursor-pointer flex flex-between">
                  See More Details <span className="ml-1">→</span>
                </span>
</li> */}

<li className="font-roboto text-[16px] leading-[19.2px] text-[#171717] my-2 flex items-center justify-between">
  ...
  <a href="#" className="text-blue-500 underline cursor-pointer flex items-center ml-4">
    See More Details <span className="ml-1">→</span>
  </a>
</li>
 </ul>
