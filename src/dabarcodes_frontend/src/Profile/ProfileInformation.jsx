...
//       className="p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
//       value={formData.retailerPreference}
//       onChange={handleChange}
//     />
//               </div>
//               {/* <div className="flex flex-col">
              ...
              <Form>
                ...
                <div className="py-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-black font-semibold">90%</span>
                    <div className="flex items-center ml-4 border border-gray-300 rounded">
                      <MdOutlineModeEdit className="h-4 w-4 text-gray-500 p-1" />
                      <a href="#" className="text-gray-500 font-medium px-2 py-1">Edit Profile</a>
                    </div>
                  </div>
                </div>
