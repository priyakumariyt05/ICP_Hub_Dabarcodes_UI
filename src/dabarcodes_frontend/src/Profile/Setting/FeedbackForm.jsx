...
//       <h1 className="text-2xl font-semibold mb-4 font-roboto">Support and Feedback</h1>
      
//       <h2 className="text-lg font-medium mb-2 font-roboto">Feedback</h2>
//       <p className="mb-4 font-roboto">What do you think of the website daBARDODES?</p>
      
//       <div className="grid grid-cols-5 gap-2 mb-4 font-roboto">
//         {ratings.map((rating) => (
//           <button
//             key={rating.value}
...
//           >
//             <FaRegWindowMaximize className="mx-auto text-3xl mb-2" />
...
//       <textarea
//         className="w-full p-3 border border-gray-300 rounded-lg mb-4 font-roboto"
//         rows="3"
...
//   />
//   <label htmlFor="contactMe" className="font-roboto">
