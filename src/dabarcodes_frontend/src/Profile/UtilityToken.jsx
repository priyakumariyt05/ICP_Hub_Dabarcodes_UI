...
//                 <h2 className="text-xl md:text-2xl font-semibold mb-4">Utility Token</h2>
...
//     <li className="flex items-center text-sm text-center">
//       <span className="w-2 h-2 bg-blue-800 inline-block rounded-full mr-2"></span>
//       Total utility token 99
//     </li>
//     <li className="flex items-center text-sm text-center">
...
//                             {/* <h3 className="text-lg font-bold pb-2">Check all Fixed Linked SKU</h3> */}
//                             <p 
...
//   }}
// >
//   Number of SKU: <span className="font-bold text-black">14</span>
// </p>
...
//   }}
// >
//   SKUs with Active Promotions: <span className="font-bold">4</span>
// </p>
...
//                             {/* <p className="text-sm pb-1">Linked to: <span className="font-bold text-black">SKU Name</span></p> */}
//                             <p 
//   className="text-sm pb-1" 
//   style={{ 
//     fontFamily: 'Roboto, sans-serif', 
...
//   }}
// >
//   Linked to: <span className="font-bold text-black">SKU Name</span>
// </p><p 
//   className="text-sm pb-2" 
//   style={{ 
//     fontFamily: 'Roboto, sans-serif', 
...
//                             {/* <p className="text-sm pb-2">Expiring on: <span className="font-bold">Sept 19, 2024</span></p> */}
//                         </div>
//                         <div className="bg-blue-100 text-blue-500 text-xs font-semibold px-2 py-1 rounded-full">USED</div>
//                     </div>
...
const UtilityToken = () => {
    ...
    return (
        ...
        <div className="flex flex-col md:flex-row min-h-screen p-6">
            <LeftSidebar/>
            <main className="flex-1 p-4 md:p-6 lg:p-12">
                <h2 className="text-xl md:text-2xl font-bold mb-4 font-roboto"> My Utility Token</h2>
                <hr className="border-t-2 border-gray-300 mb-4" />
                <h1 className=" md:text-xl font-bold mb-4 font-roboto">Utility Token</h1>
              <div className="flex flex-col md:flex-row items-start gap-4 md:gap-8">
  ...
  <ul className="flex flex-col space-y-2 md:space-y-2 mt-4 md:mt-24">
    ...
    <li className="flex items-center text-l font-roboto text-bold text-[#69bad8]">
      <span className="w-2 h-2 bg-blue-500 inline-block rounded-full mr-2 "></span>
      Unused utility tokens  <span className='text-black ml-2'>34</span>
    </li>
  </ul>
</div>
<section className="space-y-4 pt-6">
