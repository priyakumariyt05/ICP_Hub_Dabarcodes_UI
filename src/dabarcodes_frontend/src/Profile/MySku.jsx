...
const MySku = () => {
    const products = [
        ...
        { name: 'Fresh Fruit', discount: '20% OFF', bgColor: 'bg-green-100', imageUrl: '/image/dairy.png' },
           { name: 'Frozen Meat', discount: '30% OFF', bgColor: 'bg-red-100', imageUrl: '/image/dairy.png' },
                ...
                { name: 'Fresh Fruit', discount: '20% OFF', bgColor: 'bg-green-100', imageUrl: '/image/dairy.png' },
                { name: 'Frozen Meat', discount: '30% OFF', bgColor: 'bg-red-100', imageUrl: '/image/dairy.png' },
                { name: 'Frozen Drink', discount: '30% OFF', bgColor: 'bg-blue-100', imageUrl: '/image/dairy.png' },{ name: 'Packed Corn', discount: '25% off at $18', bgColor: 'bg-yellow-100', imageUrl: '/image/dairy.png' },
    ...
    {/* Data Row */}
    {/* <div className="flex items-left space-x-4 border border-gray-300 rounded-xl mb-4">
  <div className="p-4 rounded-md text-center flex-shrink-0">
  ...
  <div className="p-4 rounded-md text-center flex-shrink-0">
    <p className="text-medium font-medium font-roboto">Floating SKUs</p>
  </div>
  <div className="p-4 rounded-md text-center flex-shrink-0">
    <p className="text-medium font-medium font-roboto">SKUs Wishlist</p>
  </div>
  <div className="p-4 rounded-md text-center flex-shrink-0">
    <p className="text-medium font-medium font-roboto">Unlinked SKUs</p>
  </div>
</div> */}
...
<div className="flex flex-wrap items-start space-x-4 border border-gray-300 rounded-xl mb-4">
  ...
  <div className="mt-4 md:mt-0 md:ml-6 grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
    <div>
      ...
      <p className='font-medium font-roboto'>Fresh and Vegetable: 54</p>
      <p className='font-medium font-roboto'>Shelf Stable Food: 45</p>
    </div>
    <div>
